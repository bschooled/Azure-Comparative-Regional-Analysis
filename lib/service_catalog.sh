...
declare -ga DEFAULT_DEPLOYABLE_PROVIDER_SUPPLEMENTS
...
# SECURITY SERVICES
# ==============================================================================
SERVICE_PROVIDERS[security]="Microsoft.KeyVault"
SERVICE_API_VERSIONS[Microsoft.KeyVault]="2023-07-01"
SERVICE_RESOURCE_TYPES[Microsoft.KeyVault]="vaults,managedHSMs"

# ==============================================================================
# IOT SERVICES
# ==============================================================================
SERVICE_PROVIDERS[iot]="Microsoft.Devices"
SERVICE_API_VERSIONS[Microsoft.Devices]="2023-06-30"
SERVICE_RESOURCE_TYPES[Microsoft.Devices]="iotHubs,provisioningServices"

# Default deployable-provider supplements for services_compare.sh.
# The curated feature catalog is the primary source for the default scope.
# Only add a short list of extra high-signal deployable namespaces here.
DEFAULT_DEPLOYABLE_PROVIDER_SUPPLEMENTS=(
    "Microsoft.Compute"
    "Microsoft.Network"
...
get_default_deployable_provider_supplements() {
    printf '%s\n' "${DEFAULT_DEPLOYABLE_PROVIDER_SUPPLEMENTS[@]}"
}
...
export -f get_default_deployable_provider_supplements
